...
#print(f'Name: {apophis.name}')   #Python 3.6

print('Name: {}'.format(apophis.name))   #Python 3.5

#print(f'Diameter: {apophis.diameter}m')   #Python 3.6

print('Diameter: {}m'.format(apophis.diameter))   #Python 3.5